...
const ProjectCard = ({ heading, imageSrc, title, brief, content }) => {
  ...
  return (
    <>
      <div className="bg-[#FFE9AD] p-6 rounded shadow-md">
        ...
        <h3 className="mt-4 text-xl font-bold text-[#BD2720]">{title}</h3>
        <p className="mt-2 text-gray-700 text-justify">{brief}</p>
        <button
          onClick={openModal}
          className="mt-4 bg-[#BD2720] hover:bg-[#9F1B13] text-white py-2 px-4 rounded"
        >
          View Details
        </button>
      </div>
